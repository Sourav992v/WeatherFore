...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        type = mContext.getContentResolver().getType(
                WeatherContract.WeatherEntry.buildWeatherUriWithDate(testLocation, testDate));
    ...
    public void testInsertReadProvider() {
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherContract.WeatherEntry.buildWeatherUriWithDate(TestUtilities.TEST_LOCATION, TestUtilities.TEST_DATE),
                null,
                null,
                null,
                null
